...
public class CCEventListener {
    // TODO: configurable
    private static final String CC_COLOR_MSG = "%player% has learned something new: \"%title%\"";
    private static final String CC_DIMSTRUCT_MSG = "%player% has learned something new: \"%title%\"";
    private static final String CC_FRAGMENT_MSG = "%player% has learned something new: *%title%*";
    private static final String CC_PROGRESS_MSG = "%player% has learned something new: __%title%__";
